...
The original gem (available thru rubygems) was written when Rails 3 first came on the scene. This works with the following in your Gemfile, (you may want to change the version number).

<pre>
gem "paranoid", :require => 'paranoid', :version => ">= 0.0.7"
</pre>

As Rails has marched on, various forks have arisen to deal with the changes in underlying ActiveRecord. Notably:

* https://github.com/create-philipp-ullmann/paranoid (distributed as "paranoid_create" on rubygems, and updated to activerecord 3.1)
  <pre>
  gem "paranoid_create", :require => 'paranoid', :version => ">= 0.1.0"
  </pre>
* https://github.com/evendis/paranoid (updated to activerecord 3.2)
  <pre>
  gem "paranoid", :require => 'paranoid', :git => 'git://github.com/evendis/paranoid', :branch => 'rails32'
  </pre>
...
h3. and you may ask yourself, where does that highway go to? .. contributing to paranoid
...
h3. Setting up development environment
...
NB: 'spec' is actually the default rake task.
